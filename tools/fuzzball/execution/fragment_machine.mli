...
class virtual fragment_machine : object
  ...
  method virtual set_load_hook :
    (int64 -> int -> unit) -> unit

  method virtual set_store_hook :
    (int64 -> int -> string -> unit) -> unit
  ...
  method virtual store_symbolic_byte  : int64 -> string -> unit
	method virtual store_symbolic_byte_expr : int64 -> Vine.exp -> unit	
...
sig
  class frag_machine : object
    ...
    method concretize_misc : unit
		method set_eip_hook : (int64 -> unit) -> unit
    ...
    method run_jump_hooks : string -> int64 -> int64 -> unit
		method run_store_hooks : int64 -> int -> string -> unit
		method set_store_hook : (int64 -> int -> string -> unit) -> unit
		method run_load_hooks : int64 -> int -> unit
		method set_load_hook : (int64 -> int -> unit) -> unit	

    method set_cjmp_heuristic :
      (int64 -> int64 -> int64 -> float -> bool option -> bool option) -> unit
			
    method set_finish_path_hook :
      (unit -> unit) -> unit

    method set_load_hook :
      (int64 -> int -> unit) -> unit

    method set_store_hook :
      (int64 -> int -> string -> unit) -> unit			
    ...
    method store_symbolic_byte  : int64 -> string -> unit
		method store_symbolic_byte_expr : int64 -> Vine.exp -> unit
    ...
    method eval_expr_to_string : Vine.exp -> string
