...
#else
  BX_INFO(("| GDTR=%08x-%08x  IDTR=%08x-%08x", (unsigned) BX_CPU_THIS_PTR gdtr.base, 
	   (unsigned)  BX_CPU_THIS_PTR gdtr.base + BX_CPU_THIS_PTR gdtr.limit - 1,
	   (unsigned) BX_CPU_THIS_PTR idtr.base,
	   (unsigned) BX_CPU_THIS_PTR idtr.base + BX_CPU_THIS_PTR idtr.limit - 1));
#endif
